...
const ProfileButton = () => {
    ...
    const displayname = useSelector((state) => state.auth.accessToken.displayName);
    ...
    }, [displayName, country, password, confirmPassword]);
    return (
        <div className={classes.root} id="profile-main">
            <IconButton
                edge="end"
